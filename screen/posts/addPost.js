					...
					<View style={styles.contentBody}>
						...
						<View style={styles.betweenBody}>
							<TextInput
								...
								value={text}
								placeholder={selectedImages !== [] ? 'Hãy nói gì về bức ảnh này' : 'Bạn đang nghĩ gì? '}
							/>
						</View>
						<View>
							{selectedVideo !== null ? (
					...
					<View style={styles.footer}>
						{vertical ? (
							<View style={styles.iconFooterCol}>
								<TouchableOpacity style={styles.item} onPress={() => setShowImagePicker((pre) => !pre)}>
									<Ionicons name="md-images" size={24} color="green" style={styles.icon} />
									<Text>Ảnh/video</Text>
								</TouchableOpacity>
								<TouchableOpacity style={styles.item} onPress={() => handleVideoPick()}>
									<Entypo name="emoji-happy" size={24} color="#F5C33B" style={styles.icon} />
									<Text>Video</Text>
								</TouchableOpacity>
								<TouchableOpacity style={styles.item}>
									<Entypo name="camera" size={24} color="#0091ff" style={styles.icon} />
									<Text>Camera</Text>
								</TouchableOpacity>
								<TouchableOpacity style={styles.item} onPress={() => setVertical(!vertical)}>
							...
							<View style={styles.iconFooter}>
								...
								<TouchableOpacity onPress={() => setVertical(!vertical)}>
									<MaterialCommunityIcons name="dots-horizontal-circle" size={24} color="#555" />
								</TouchableOpacity>
							</View>
						)}
					</View>
